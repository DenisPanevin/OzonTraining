...
/*
задача про испорченный сервер. сервер может обрабатывать только два уникальных запроса подряд
на вход подается сет запросов состоящий из их id
требуется найти максимальное число запросов в каждом сете
 */
