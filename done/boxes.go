...
/*на складе есть коробки с какой то массой, так же есть некоторое число автомобилей с некоторой грузоподъемностью
требуется найти минимальное число поездок что бы разгрузить склад
*/
