...
/*
задача на поиск одинаковых логинов
одинаковым считается логины которые полностью идентичны или если в одном поменять пару соседних символов он станет идентичным
например zooner ozoner считаются одинаковыми логинами. решение у меня супер неэффективное
*/
func main() {
